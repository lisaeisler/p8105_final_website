...
We conclude that for every 1 unit (years) increase in age, the log odds of being discharged home decreased by 0.196 (holding constant other variables in the model). Therefore, the odds of home discharge as patients age by 1 year are 0.82x the odds, telling us that every advancing year decreases the odds of discharge to home by 18%.
...
Important pre-operative indicators that have been identified for other patients who undergo spinal fusion surgery, such as asthma, chronic lung disease, need for nutritional support and severity of the scoliosis do not appear to have a significant impact on the outcome for individuals with CP in our model and population. When we exponentiate the betas for asthma, chronic lung disease, need for nutritional support and severity of the scoliosis, we observe the following odds ratios: 
For patients with CP who have asthma, the odds to be discharged to home decrease by 28% (compared to those without asthma). 
For patients with CP who have nutritional support the odds to be discharged to home decrease by 27% (compared to those without need for nutritional support)
For patients with CP who have severe scoliosis requiring 13 or more vertebral levels to be fused, the odds to be discharged to home decrease by 12%.
Surprisingly, having chronic lung disease appears to be protective towards home discharge.
