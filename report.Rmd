...
For every year increase in age the odds of being released to a health care facility (not home) increase by 22% (1/.82=1.22) (all other variables remain constant).
The odds of being discharged at home if you have a pre-existing hematological disorder are 0.28. This means that if the patient with CP has a pre-existing hematologic disorder the odds of being discharged to a health care facility are 3.7 (1/.27=3.7) the odds of being discharged to home (all other variables remain constant). 
